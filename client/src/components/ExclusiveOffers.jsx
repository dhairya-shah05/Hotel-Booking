...
const ExclusiveOffers = () => {
    return (
        <div className='flex flex-col md:flex-col items-center px-6 md:px-16 lg:px-24
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12'>
                {exclusiveOffers.map((items) => (
                    <div key={items._id} className='group relative flex flex-col items-start justify-between
