                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-wrap items-center mt-3 mb-6 gap-4">
                        {room.amenities.map((item, index) => (
                            <div key={index} className="flex items-center mt-3 gap-2 px-3 py-2
            ...
            mx-auto mt-16 max-w-6xl">
                ...
                gap-4 md:gap-10 text-gray-500">
                    <div className="flex flex-col">
                        ...
                        <input type="date" id="checkInDate" placeholder="Check-In" className="w-full rounded-2xl
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="date" id="checkOutDate" placeholder="Check-Out" className="w-full rounded-2xl
                        border border-gray-300 px-3 py-2 mt-1.5 outline-none" required />
                    </div>
                ...
                active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25
