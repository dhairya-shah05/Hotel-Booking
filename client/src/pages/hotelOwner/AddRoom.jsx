...
const AddRoom = () => {
    ...
    return (
        <form>
            ...
            details carefully and accurate room details, pricing, and amenities, to enhance
            ...
            <div className="flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm">
                {Object.keys(inputs.amenities).map((amenity, index)=>(
                    <div key={index}>
                        ...
                        onChange={()=>setInputs({...inputs, amenites: {...inputs.amenities, [amenity]: !inputs.amenites[amenity]}})}/>
