...
const Dashboard = () => {
    ...
    const { currency, user, getToken, taost, axios } = useAppContext();
    ...
    return (
        <div>
            ...
            your room listings, track bookings and analyze revenue all 
            ...
            <div className='flex gap-4 my-8'>
                ...
                p-4 pr-8'>
                    <img src={assets.totalBookingIcon} alt="booking icon" className='max-sm:hidden
                    h-10'/>
                ...
                <div className='bg-primary/3 border border-primary/10 rounded flex
                p-4 pr-8'>
                    <img src={assets.totalRevenueIcon} alt="revenue icon" className='max-sm:hidden
                    h-10'/>
                    <div className='flex flex-col sm:ml-4 font-medium'>
